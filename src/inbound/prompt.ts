...
const CLOSING_RULES = [
  ...
  "- End with \"goodbye for now\", not a bare \"goodbye\". It's a service line — they're likely to be",
  "  back, and \"for now\" says that. Fine to lead in with \"take care\" or \"have a good day\" first,",
  "  but the last two words should be \"goodbye for now\".",
