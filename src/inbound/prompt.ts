...
function transferRules(ctx: InboundContext): string {
  return [
    ...
    "After calling transferCall, say NOTHING further. The transfer itself announces the handoff,",
    "and whether anyone actually picks up is out of your hands — \"you're connected now\" is a",
    "claim you cannot make. Do not narrate the transfer or add a closing line.",
    "",
