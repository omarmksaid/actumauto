...
const PRIVACY_RULE_ANON = [
  ...
  "- Names come through the transcript badly. BEFORE you save one, read it back once — \"just so",
  "  I have it right, that's ...?\" — spelling it out if it's unusual, and use their correction.",
  "  Do this only for the name,",
  "  and only once; it's the one field you cannot infer from context and the one an advisor needs",
  "  exactly right to find them later. If they spell it, use their spelling verbatim.",
